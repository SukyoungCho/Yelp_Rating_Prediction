---
title: "333_Project2_final"
author: "Sukyoung Cho, Yupei Lin, Crystal Liu, Nan Yang"
date: '2019 4 21 '
output: pdf_document
---

##Preparation before dealing with the data by Sukyoung Cho
```{r}
...
##Create a function for TF_IDF to weight the words different:
...
write.csv(result,"prediction_tfidf_stepwise_crossvalidation.csv", row.names = FALSE)
```
